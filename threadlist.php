...
<html lang="en">
  ...
  <strong>Success!</strong>  Your thread has been posted! Please wait community to respond.
...
Remain respectful of other members at all times.</p>
  <a class="btn btn-success btn-lg" href="#" role="button">Learn more</a>
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
        ...
        echo '<div class="jumbotron jumbotron-fluid" style="margin-left:118px; margin-right:118px;">
        <div class="container">
    ...
    ?>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
       ...
       echo'   <div class="media my-3">
          ...
          <h5 class="font-weight-bold my-0">'. $row2['username'] . ' at '. $thread_time .'</h5>
          <h6 class="mt-0"><a class="text-dark" href="thread.php?threadid='. $id .'">'. $title .'</a></h6>
              '. $desc .'
